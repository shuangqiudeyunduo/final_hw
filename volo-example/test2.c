...
int main()
{
    ...
    char commandToSend4[256] = "set 127.0.0.1:8081 2 4";
    sendKeysToTerminal(childHwnd2, commandToSend4);
    char commandToSend[256] = "get 127.0.0.1:8081 2";
    ...
    sendKeysToTerminal(childHwnd2, commandToSend3);
